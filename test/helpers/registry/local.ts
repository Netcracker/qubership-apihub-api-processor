...
export class LocalRegistry implements IRegistry {
  ...
  async publishPackage(
    ...
    const comparisonsDto: VersionsComparisonDto[] = comparisons.map(comparison => toVersionsComparisonDto(comparison, builderContext.normalizedObjectsHashCache, logError))
