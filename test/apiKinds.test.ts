...
import * as bwcValidation from '../src/components/compare/bwc.validation.rest'
import { calculateOperationApiCompatibilityKind } from '../src/components/compare/bwc.validation.rest'
