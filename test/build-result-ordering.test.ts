...
// Which document owns a contested id is an ordering decision too: the winner is the smaller `documentId`, so
// the published index does not depend on the order `config.files` happened to list the documents in.
