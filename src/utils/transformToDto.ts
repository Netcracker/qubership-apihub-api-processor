  ...
  switch (action) {
    case DiffAction.add: {
      ...
      return {
        ...
        currentValueHash: afterValueNormalized !== undefined ? getHash(afterValueNormalized) : '',
      }
    }
    case DiffAction.remove: {
      ...
      return {
        ...
        previousValueHash: beforeValueNormalized !== undefined ? getHash(beforeValueNormalized) : '',
      }
    }
